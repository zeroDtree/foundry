"""Unit tests for the pure helpers in ``rfd3na.utils.io``.
...
Named ``test_rfd3na_io`` to avoid a pytest basename clash with rfd3's ``test_rfd3_io``
and rf3's ``test_rf3_io`` under the suite's prepend import mode.
"""
